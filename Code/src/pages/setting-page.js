  ...
  return (
    <div className="w-full relative bg-white h-[64rem] overflow-hidden text-left text-[1.125rem] text-primary-2 font-heading-four-semibold-20p">
      ...
      <div className="absolute top-[8.188rem] left-[18.125rem] w-[69.375rem] h-[33.188rem] text-[1rem] text-gray-300">
        ...
        <div
          className="absolute top-[2.313rem] left-[12.563rem] font-medium text-steelblue cursor-pointer"
          onClick={onPreferencesTextClick}
        >
          Preferences
        </div>
        <div className="absolute top-[2.313rem] left-[23.125rem] font-medium text-blue-200">
          Security
        </div>
        <div className="absolute top-[4.125rem] left-[1.875rem] bg-whitesmoke-300 w-[65.625rem] h-[0.063rem]" />
        <div className="absolute top-[4rem] left-[21.563rem] rounded-t-3xs rounded-b-none bg-blue-200 w-[7.125rem] h-[0.188rem]" />
        <div className="absolute top-[6.5rem] left-[1.875rem] text-[1.063rem] font-medium text-darkslateblue-100">
          Two-factor Authentication
        </div>
        <div className="absolute top-[12.625rem] left-[1.875rem] text-[1.063rem] font-medium text-darkslateblue-100">
          Change Password
        </div>
        <div className="absolute top-[9rem] left-[1.875rem] w-[25.063rem] h-[1.919rem]">
        ...
        <div className="absolute top-[14.938rem] left-[1.875rem] w-[31.875rem] h-[5rem]">
        ...
        <div className="absolute top-[21.313rem] left-[1.875rem] w-[31.875rem] h-[5rem]">
          <div className="absolute top-[0rem] left-[0rem]">New Password</div>
          <div className="absolute top-[1.875rem] left-[0rem] w-[31.875rem] h-[3.125rem] text-[0.938rem] text-steelblue">
            <div className="absolute top-[0rem] left-[0rem] rounded-mini bg-white box-border w-[31.875rem] h-[3.125rem] border-[1px] border-solid border-aliceblue-600" />
            <div className="absolute top-[1rem] left-[1.25rem]">**********</div>
          </div>
